...
export const en: Messages = {
  ...
  stateUserMuted: { message: "Manually muted" },
  userMutedBanner: { message: "Auto-unmute paused (manually muted)" },
  resumeAutoMute: { message: "Resume Auto" },
...
export const ja: Messages = {
  ...
  stateUserMuted: { message: "手動ミュート中" },
  userMutedBanner: { message: "手動ミュート中のため自動解除を一時停止" },
  resumeAutoMute: { message: "自動に戻す" },
